...
class EventController extends Controller
{
    ...
    public function show(Event $event)
    {
        ...
        $event->load('category', 'location', 'contentAdvisories', 'contactLevels', 'mobilityAdvisories', 'eventreviews', 'staffpick', 'advisories', 'showOnGoing','interactive_level', 'remotelocations', 'timezone','genres','ratings.user', 'priceranges', 'organizer', 'shows', 'age_limits');
