export default {
    methods: {
        ...
        updateLats(e) {
            this.inputVal.event.location.latitude = e.geometry.location.lat();
            this.inputVal.event.location.longitude = e.geometry.location.lng();
        },
        ...
        updateLocationFields(input) {
            if ((input !== null) && (typeof input === "object") && (input.id !== null)) {
                this.inputVal.event.location = _.extend( this.inputVal.event.location, input);
            }
        },
