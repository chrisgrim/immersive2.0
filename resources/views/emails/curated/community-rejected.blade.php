    ...
    <div style="border: 1px solid #dddddd; border-radius: 12px;overflow: hidden;max-width: 1000px;margin:40px auto">
        <div style="margin: auto;padding:40px 20px;">
            <div style="margin-bottom: 10px;">
                <h2 style="font-family: 'Secular One', sans-serif;font-size: 30px;margin:0">Sorry</h2>
            </div>
            <div style="margin-bottom: 35px;">
                <span style="font-family: 'Sen', sans-serif;color: #6d6d6d;">
                    <p>After reviewing your community <b>{{$name}}</b> our moderators have decided it is not the right fit for Everything Immersive. <br><br>
                    <b>Reason:</b></p>
                    <p style="font-size: 14px;">{{$comments}}</p>
                    <br>
                    <p>If you feel we have made a mistake in our decision, please send us an email to contact@everythingimmersive.com</p>
                </span>
            </div>
            <div>
                <span style="font-family: 'Sen', sans-serif;color: #6d6d6d;">
