...
@section('meta')
    ...
    <meta property="og:image" content="{{ env('MIX_IMAGE_URL') }}{{$event->largeImagePath}}" />
    <meta property="og:image:secure_url" content="{{ env('MIX_IMAGE_URL') }}{{$event->largeImagePath}}" />
